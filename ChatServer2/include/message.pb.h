...
class KickUserRsp final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:message.KickUserRsp) */ {
 public:
  ...
  KickUserRsp* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class KickUserReq final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:message.KickUserReq) */ {
 public:
  ...
  KickUserReq* New(::google::protobuf::Arena* arena = nullptr) const final {
